...
# Copyright (c) 2010-2017 The Bitcash Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Bitcash P2P network half-a-node.
...
MAGIC_BYTES = {
    "mainnet": b"\xf8\xc2\xb4\xe3",   # mainnet
    "testnet3": b"\x03\x15\x08\x03",  # testnet3
    "regtest": b"\xf1\xb3\xd4\xc3",   # regtest
}
...
class P2PConnection(asyncore.dispatcher):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.debug('Connecting to Bitcash Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Bitcash node.
