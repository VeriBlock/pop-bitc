...
#ifndef BITCASH_QT_BITCASHUNITS_H
#define BITCASH_QT_BITCASHUNITS_H
...
/** Bitcash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcashUnits(QObject *parent);

    /** Bitcash units.
      @note Source: https://en.bitcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BITC,
...
typedef BitcashUnits::Unit BitcashUnit;

#endif // BITCASH_QT_BITCASHUNITS_H
