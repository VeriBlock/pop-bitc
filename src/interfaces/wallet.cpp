...
public:
    ...
    void GetScriptForMining(std::shared_ptr<CReserveScript> &script) override { m_wallet.GetScriptForMining(script); }
    ...
    bool importWallet(const std::string& filename) override { return m_wallet.ImportWallet(filename); }
    std::string getWalletName() override { return m_wallet.GetName(); }
    CPubKey GetCurrentAddressPubKey() override { return m_wallet.GetCurrentAddressPubKey(); }
    ...
    bool RegisterNickname(std::string nick, std::string addr,std::string& strFailReason) override { return m_wallet.RegisterNickname(nick,addr,strFailReason); }
