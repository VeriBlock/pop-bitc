...
#ifndef BITCASH_WALLET_WALLET_H
#define BITCASH_WALLET_WALLET_H
...
public:
     ...
     * on this bitcash node, and set to 0 for transactions that were created
...
public:
    ...
    isminetype IsMine(const CTxIn& txin);
    /**
...
//    bool SetNickname(const std::string& strName,const std::string address);
