        ...
        uint8_t nThreads)
{
    ...
    do {
        const auto pblocktemplate =
            BlockAssembler(Params()).CreateNewBlock(NULL, pwallet, false);
...
UniValue getblocktemplate(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "    https://github.com/bitcash/bips/blob/master/bip-0022.mediawiki\n"
            "    https://github.com/bitcash/bips/blob/master/bip-0023.mediawiki\n"
            "    https://github.com/bitcash/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
            "    https://github.com/bitcash/bips/blob/master/bip-0145.mediawiki\n"
...
/*    if (IsInitialBlockDownload())
        ...
        fLastTemplateSupportsSegwit != fSupportsSegwit)
    {
        ...
        pblocktemplate = BlockAssembler(Params()).CreateNewBlockWithScriptPubKey(scriptDummy, fSupportsSegwit);
        if (!pblocktemplate)
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2) {
        throw std::runtime_error(
            ...
            "See https://en.bitcash.it/wiki/BIP_0022 for full specification.\n"
